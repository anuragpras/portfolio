...
def main():
    ...
    # About Me section
    st.header('About Me')
    st.write('Computer Science undergraduate at VIT Bhopal with a passion for AI/ML, data science, and software development. I\'m eager to contribute my skills to innovative technical roles.')
